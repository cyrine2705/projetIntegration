...
class _HomeCollectorState extends State<HomeCollector> {
            ...
            child: Row(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: <Widget>[CollectorLogout()]),
                  )
                ]),
          ),
  ...
  void fetchRecycleRequests() async {
    RecycleRequestManagementService.getAllRecycleRequests(
