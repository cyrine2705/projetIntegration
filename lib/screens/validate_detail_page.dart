...
class _ValidatePageState extends State<ValidatePage> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        leading: IconButton(
          ...
          onPressed: () {
            setState(() {
              Get.off(CompleteRecycleRequest());
            });
          },
        ),
  ...
  void completeRecycleRequest(int recycleRequestId) async {
    RecycleRequestManagementService.completeRecycleRequest(
